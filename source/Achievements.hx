...
class Achievements {
	public static var achievementsStuff,
	:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Expert Traumatiser",	"Beat flippy's week with no misses.",						'week0_nomizz',	 false],			 true]
	];
